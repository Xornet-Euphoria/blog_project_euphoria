...
したがってとなるような整数$k$が存在する事から

$$
s \equiv msg^{a+b} \bmod N
$$

である。であることから、$s^e \equiv msg \bmod N$である(オイラーの定理)。よって最終的にRSA署名を生成している事がわかる。
...
一方で$q-1$を法とした時の`a`はどうなるかを考える。であることから
